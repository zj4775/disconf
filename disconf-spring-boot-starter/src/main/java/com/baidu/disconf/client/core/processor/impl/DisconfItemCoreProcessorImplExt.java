...
public class DisconfItemCoreProcessorImplExt implements DisconfCoreProcessor {
    ...
    public DisconfItemCoreProcessorImplExt(WatchMgr watchMgr, FetcherMgr fetcherMgr, Registry registry,ApplicationContext applicationContext) {
    ...
    public void processOneItem(String key) {
        ...
        DisconfCenterItem disconfCenterItem =  disconfStoreProcessor.getConfItemData(key);
    ...
    private void updateOneConfItem(String keyName, DisconfCenterItem disconfCenterItem) throws Exception {
        ...
        // 注入到仓库中
        //
        disconfStoreProcessor.inject2Store(keyName,null, new DisconfValue(value, null));
    ...
    private void inject2OneConf(String key, DisconfCenterItem disconfCenterItem) {
        ...
        try {
            ...
            disconfStoreProcessor.inject2Instance(disconfCenterItem, key);
