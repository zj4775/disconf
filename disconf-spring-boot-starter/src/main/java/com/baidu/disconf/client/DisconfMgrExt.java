...
import com.baidu.disconf.client.core.DisconfCoreFactoryExt;
...
public class DisconfMgrExt implements ApplicationContextAware {
    ...
    protected synchronized void firstScan(List<String> scanPackageList) {
        ...
        try {
            ...
            // 导入配置
            ConfigMgr.init(applicationContext.getEnvironment());
            ...
            // 获取数据/注入/Watch
            disconfCoreMgr = DisconfCoreFactoryExt.getDisconfCoreMgr(registry,applicationContext);
