...
public class ScanStaticModel {
     ...
     * yml配置文件
     */
    private Set<Class<?>> disconfYmlFileClassSet;
    //
    // 配置文件
    ...
    public Set<Class<?>> getDisconfYmlFileClassSet() {
        return disconfYmlFileClassSet;
    }

    public void setDisconfYmlFileClassSet(Set<Class<?>> disconfYmlFileClassSet) {
        this.disconfYmlFileClassSet = disconfYmlFileClassSet;
    }
