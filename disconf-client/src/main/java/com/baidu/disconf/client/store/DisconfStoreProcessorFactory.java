...
import com.baidu.disconf.client.store.processor.impl.DisconfYmlStoreFileProcessorImpl;
...
public class DisconfStoreProcessorFactory {
     ...
     * 获取配置文件仓库算子
     */
    public static DisconfStoreProcessor getDisconfYmlStoreFileProcessor() {

        return new DisconfYmlStoreFileProcessorImpl();
    }
