...
public class ConfigMgr {
     ...
     * @throws Exception
     */
    public synchronized static void init(Environment environment) throws Exception {
        ...
        // 导入系统配置
        DisClientSysConfig.getInstance().loadConfig(environment);

        // 校验 系统配置
        DisInnerConfigHelper.verifySysConfig();

        // 导入用户配置
        DisClientConfig.getInstance().loadConfig(environment);
