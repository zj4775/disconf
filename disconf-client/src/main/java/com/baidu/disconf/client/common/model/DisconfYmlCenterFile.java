 ...
 * @version 2014-5-20
 */
public class DisconfYmlCenterFile extends DisconfCenterBaseModel {

    protected static final Logger LOGGER = LoggerFactory.getLogger(DisconfYmlCenterFile.class);
