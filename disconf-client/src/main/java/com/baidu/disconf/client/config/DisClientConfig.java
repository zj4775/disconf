...
public final class DisClientConfig {
    ...
    public boolean isGLOBAL_SHARE_ENABLE() {
        return GLOBAL_SHARE_ENABLE;
    }
    @DisInnerConfigAnnotation(name = "disconf.global.app", defaultValue = "GLOBALPROP")
    private String GLOBAL_APP;
    @DisInnerConfigAnnotation(name = "disconf.global.version", defaultValue = "1.0.0")
    private String GLOBAL_VERSION;
    @DisInnerConfigAnnotation(name = "disconf.global.key", defaultValue = "global")
    private String GLOBAL_KEY;
    @DisInnerConfigAnnotation(name = "disconf.global.share", defaultValue = "true")
    private boolean GLOBAL_SHARE_ENABLE;
