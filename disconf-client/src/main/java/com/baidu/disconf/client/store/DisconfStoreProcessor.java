...
public interface DisconfStoreProcessor {
     ...
     * 获取指定配置Data
     */
    List<DisconfCenterFile> getConfData(String key);
    /**
     * 获取yml指定配置Data
     */
    List<DisconfYmlCenterFile> getConfYmlData(String key);

    /**
     * 获取指定配置Data
     */
    DisconfCenterItem getConfItemData(String key);
     ...
     * 将对象object中的数据注入配置中
     */
    void inject2Instance(DisconfCenterFile disconfCenterFile, String keyName);
    /**
     * 将对象object中的数据注入配置中
     */
    void inject2Instance(DisconfYmlCenterFile disconfCenterFile, String keyName);

    void inject2Instance(DisconfCenterItem disconfCenterItem, String keyName);
     ...
     * 将配置数据注入到仓库
     */
    void inject2Store(String fileName, DisconfCenterFile disconfCenterFile,DisconfValue disconfValue);
